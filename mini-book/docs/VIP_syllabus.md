...
TAs (sub-team leads): Todd Whittaker, Nick Matteucci, Sayan Bhowmik,
Neung-Kyung Yu, Seongeun Yun, Charlotte Shih
...
science. The VIP course consists of four sub-teams with research topics
developed by graduate students in the Medford group: Training, Surface
Calculations, Single-Atom Orbital-Free, and Machine-Learned
Exchange-Correlation. Details are on the [sub-teams page](VIP_subteams.md)
and in the [overview lecture](VIP_Overview.ipynb).
...
-   Slack: The group Slack workspace is the preferred method of
    communication with instructors and graduate students. To join, first
    create an account through the
    [GT Slack enterprise account](https://gatech.enterprise.slack.com/)
    using your GT credentials, then find the team at
    [bigdataquantu-ii59559.slack.com](https://bigdataquantu-ii59559.slack.com).
...
<!-- BEGIN TRAINING-SCHEDULE (generated by course-admin-VIP/scripts/sync_schedule.py - do not hand-edit) -->
Week 1 (8/26): Introduction to VIP, syllabus overview, and project/subteam assignment

Week 2 (9/2): Overview of DFT calculations and Literature searches
> Personal Goals document due to Canvas at 11:59p ET on 9/4/26

Week 3 (9/9): Intro to HPC and basic Python tools (videos HPC.1-2 and PY.1-2) - Bi-weekly Update 1

Week 4 (9/16): Intro to Atomic Simulation Environment (ASE) (videos ASE.1-2)

Week 5 (9/23): Installing DFT software on PACE (videos PACE.1-3) - Bi-weekly Update 2 (Ex. HPC.1-4, PY.1-5 and ASE.1-3)
> Software installation check during class

Week 6 (9/30): Running DFT calculations on PACE (videos PACE.4-6)

Week 7 (10/7): Calculating an Adsorption Energy using DFT (no videos, but notebook pages) - Bi-weekly Update 3 (Ex. PACE.1-3)
> No class Mon-Tue: Fall break (Oct 5-6)

Week 8 (10/14): Sub-team project discussion
> VIP Peer Evaluation 1 (on the VIP website): complete between 10/12 and 10/23
> Compiled bi-weekly updates (midterm), Midterm Achievements document and Midterm Presentation due to Canvas at 11:59p ET on 10/16/26

Week 9 (10/21): Midterm Updates (pre-recorded presentations, virtual synchronous Q&A) - Bi-weekly Update 4 (Ex. ADS.1-3)
> Presentation content should be a brief summary of your sub-team project, your personal goals for the semester, and your progress to date

Week 10 (10/28): Intro to theory of DFT calculations (videos DFT.1-14) and Understanding and Optimizing DFT Calculations (no videos, but notebook pages)

Week 11 (11/4): Sub-team project check-in I - Bi-weekly Update 5 (Ex. CONV.1-3)

Week 12 (11/11): Sub-team project check-in II

Week 13 (11/18): Sub-team project check-in III - Bi-weekly Update 6 (No Ex. - summarize progress on sub-team project)

Week 14 (11/25): No class: Thanksgiving break

Week 15 (12/2): Final Updates (pre-recorded presentations, virtual synchronous Q&A)
> Presentation content should be a brief summary of your accomplishments and deliverables compared to your personal goals, and how your work contributes to the sub-team project. Each student should ask a question during the Q&A session - this will be considered during grading.
> VIP Peer Evaluation 2 (on the VIP website): complete between 11/30 and 12/8
> Compiled bi-weekly updates (final), Final Achievements document and Final Presentation due to Canvas at 11:59p ET on 12/4/26
